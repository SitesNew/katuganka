...
// Определяем URL С 2023 поддержка ТОЛЬКО http! Если нужно без S - исправьте!
//$boardm_url1="https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; $host=$_SERVER['HTTP_HOST'];
$boardm_url1="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; $host=$_SERVER['HTTP_HOST'];
...
<center><small>Powered by <a href=\"http://www.wr-script.ru\" title=\"Скрипт форума\" class='copyright'>WR-Board mini</a> simple &copy; 2.3<br></small></center></body></html>";
...
<a href='http://www.wr-script.ru/forum/index.php?id=104' target='_blank'><button class='knopka color'>Помощь</button></a>
...
<tr><td><B>URL</B> (не забывайте http://)</td><td><input type=text value='$dt[25]' name=www size=56 style='width:100%'></td></tr>
...
<tr><td>URL</td><td><input type=text value='' name=www size=56 placeholder='http://ваш-сайт.ru'></td></tr>
<tr><td>Спецвыделение<BR> (увеличивает рейтинг объявления)</td><td align=center><input type=button class=button value=' B ' style='font-weight:bold; width: 30px' onclick=\"DoSmilie(' [b]  [/b] ');\">&nbsp; <input type=button class=button value=' RB ' style='font-weight:bold; color:red' onclick=\"DoSmilie('[RB] [/RB]');\">&nbsp; <input type=button class=button value=' IMG ' style='font-weight:bold; color:navy' onclick=\"DoSmilie('img] [/img]');\">&nbsp; </td></tr>
...
$dt[4]=preg_replace ("#([^\[img\]])(http|http|ftp|goper):\/\/([a-zA-Z0-9\.\?&=\;\-\/_]+)([\W\s<\[]+)#i", "\\1<noindex><a href=\"\\2://\\3\" target=\"_blank\">\\2://\\3</a></noindex>\\4", $dt[4]);
...
?>
<BR><BR><center><small>Powered by <a href='http://www.wr-script.ru/'>WR-Board mini</a> &copy; 2.3 UTF-8</small></body></html>