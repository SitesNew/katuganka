<? // WR-forum mini v 2.1 //  07.01.2019 г.  //  WR-Script.ru

include "data/config.php";

if (isset($_GET['image'])) { // ‘”Ќ ÷»я ÷»‘–ќ¬ќ… «јў»“џ
$st="R0lGODlhCgAMAIABAFNTU////yH5BAEAAAEALAAAAAAKAAwAAAI"; // обща¤ часть дл¤ всех рисунков
...
// ¬ывод кодированных изображений на экран
if (array_key_exists("image", $_REQUEST)) { $num=$_REQUEST["image"];
$dopkod=mktime(0,0,0,date("m"),date("d"),date("Y")); // доп.код. ћен¤етс¤ каждые 24 часа
